    ...
    data() {
      return {
        ...
        columns: [
          ...
          {key: 'account', title: '登录用户', width: 120, align: 'center'},
          {key: 'ipAddr', title: 'IP', width: 150 , align: 'center'},
          {key: 'osName', title: '操作系统', width: 120 , align: 'center'},
          {key: 'browser', title: '浏览器', width: 120 , align: 'center'},
          ...
          {key: 'beginTime', title: '开始时间', width: 160, align: 'center'},
          {key: 'endTime', title: '结束时间', width: 160, align: 'center'},
          {key: 'costMillis', title: '耗费时间(毫秒)', width: 120, align: 'center'},
          {key: 'userAgent', title: 'User_Agent', width: 260,ellipsis:true, align: 'center'},
          {key: 'referer', title: '链接来源', width: 260, align: 'center'},
